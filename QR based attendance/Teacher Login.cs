...
namespace QR_based_attendance
{
    public partial class Teacher_Login : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlDataAdapter cmd = new SqlDataAdapter("select * from TeacherDetails where ID='" + textBox1.Text + "'and Password='" + textBox2.Text + "'", con);
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                //user=textBox1.Text;
                pass = textBox2.Text;
                Teacher_HomePage teacher_HomePage = new Teacher_HomePage();
